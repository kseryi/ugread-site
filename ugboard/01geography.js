function initGeographyPanel() {
  ...
  // Створюємо групу для всього полотна
  ...
  // Масштабування полотна від центру
  canvasScale.addEventListener('input', () => {
    ...
    // Відносне зміщення старого масштабу
  ...
  // Активувати інструмент переміщення полотна
...
// Виклик функції при завантаженні скрипта
initGeographyPanel();
